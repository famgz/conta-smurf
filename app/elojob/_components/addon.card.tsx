...
export default function AddonCard({
  ...
  return (
    <div
      className={cn(
        'flex w-full cursor-pointer items-center justify-between gap-10 whitespace-nowrap rounded-lg p-1 !pl-4 font-normal shadow-md xl:rounded-2xl xl:p-2 xl:text-3xl',
        highlight
    ...
    >
      ...
      <span
        className={cn(
          'flex-center w-[80px] rounded-lg px-4 py-1 font-extralight xl:w-[110px] xl:rounded-2xl',
