  ...
  <AccordionPrimitive.Header className="flex">
    ...
    >
      ...
      {icon === 'default' ? (
        ...
        <>
          <Plus className="ml-auto size-6 w-fit shrink-0 stroke-[3px] transition-transform duration-200 group-data-[state=open]:hidden 2xl:size-12" />
          <Minus className="ml-auto size-6 w-fit shrink-0 stroke-[3px] transition-transform duration-200 group-data-[state=closed]:hidden 2xl:size-12" />
        </>
      )}
    </AccordionPrimitive.Trigger>
