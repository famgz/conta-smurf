...
export default function Products() {
  ...
  const filters = {
    ...
    rank: [
      { title: 'bronze', icon: imagePrefix + 'bronze.png' },
      { title: 'challenger', icon: imagePrefix + 'challenger.png' },
      { title: 'diamond', icon: imagePrefix + 'diamond.png' },
      { title: 'emerald', icon: imagePrefix + 'emerald.png' },
      { title: 'gold', icon: imagePrefix + 'gold.png' },
      { title: 'grandmaster', icon: imagePrefix + 'grandmaster.png' },
      { title: 'iron', icon: imagePrefix + 'iron.png' },
      { title: 'master', icon: imagePrefix + 'master.png' },
      { title: 'no-rank', icon: imagePrefix + 'no-rank.png' },
      { title: 'platinum', icon: imagePrefix + 'platinum.png' },
      { title: 'silver', icon: imagePrefix + 'silver.png' },
    ],
    price: {
      min: 0,
      max: 2500,
